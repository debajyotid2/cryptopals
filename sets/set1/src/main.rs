...
use xorcipher::{
    encrypt_singlebyte_xor, 
    encrypt_repeatingkey_xor, 
    decrypt_singlebyte_xor, 
    decrypt_singlebyte_xor_faster,
    decrypt_repeatingkey_xor
};
use aescipher::{detect_aes_ecb_encryption, decrypt_aes_ecb};
